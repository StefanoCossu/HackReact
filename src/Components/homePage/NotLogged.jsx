    ...
    return(
        <>
            <div className="myTend py-20 relative flex w-full h-full overflow-hidden justify-evenly items-center">
                    ...
                    <div className="myTend myTendL hidden absolute w-1/2 left-0 h-full md:flex justify-center items-center bg-gradient-to-r from-[#14496c] from-80% via-[#14496cb3] via-98% to-[#14496cb3]">
                    ...
                    <div className="myTend hidden md:block myTendR absolute w-1/2 right-0 h-full  bg-gradient-to-r from-[#14496c] from-80% via-[#14496cb3] via-90% to-[#14496cb3]">
                    </div>
            </div>
